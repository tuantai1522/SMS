...
namespace SMS.Infrastructure.Migrations
{
    ...
    [Migration("20251230124426_UpdateUserEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMS.Core.Features.Users.User", b =>
                {
                    ...
                    b.Property<long?>("VerificationTokenExpiredAt")
                        .HasColumnType("bigint")
                        .HasColumnName("verification_token_expired_at");
            ...
            modelBuilder.Entity("SMS.Core.Features.Users.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CountryId")
                        .HasDatabaseName("ix_user_profiles_country_id");

                    b.HasIndex("GivenName")
                        .IsUnique()
                        .HasDatabaseName("ix_user_profiles_given_name");

                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_user_profiles_user_id");

                    b.ToTable("user_profiles", "sms");
                });

            modelBuilder.Entity("SMS.Core.Features.Users.UserSignIn", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_signins");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_signins_user_id");

                    b.ToTable("user_signins", "sms");
                });
            ...
            modelBuilder.Entity("SMS.Core.Features.Users.UserProfile", b =>
                {
                    b.HasOne("SMS.Core.Features.Countries.Country", null)
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_profiles_countries_country_id");

                    b.HasOne("SMS.Core.Features.Users.User", "User")
                        .WithOne("UserProfile")
                        .HasForeignKey("SMS.Core.Features.Users.UserProfile", "UserId")
            ...
            modelBuilder.Entity("SMS.Core.Features.Users.UserSignIn", b =>
                {
                    b.HasOne("SMS.Core.Features.Users.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_signins_users_user_id");
                });
